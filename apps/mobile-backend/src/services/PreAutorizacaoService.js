...
// crédito passa por pré-autorização (regra já validada na tela de pré-autorização).
class PreAutorizacaoService {
  confirmarAbastecimento(props) {
...
module.exports = { PreAutorizacaoService };
